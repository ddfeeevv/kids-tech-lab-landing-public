      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">{t('coursePages.arduino.title')}</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {t('coursePages.arduino.subtitle')}
            </p>
            <div className="mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 shadow-lg">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('coursePages.arduino.about.title')}</h2>
              <p className="text-gray-600 leading-relaxed mb-6">
                {t('coursePages.arduino.about.description')}
              </p>
              
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center">
                  <Clock size={20} className="text-primary-600 mr-2" />
                  <span className="text-gray-600">{t('coursePages.arduino.about.duration')}</span>
                </div>
                <div className="flex items-center">
                  <Users size={20} className="text-primary-600 mr-2" />
                  <span className="text-gray-600">{t('coursePages.arduino.about.groupSize')}</span>
                </div>
                <div className="flex items-center">
                  <Target size={20} className="text-primary-600 mr-2" />
                  <span className="text-gray-600">{t('coursePages.arduino.about.age')}</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle size={20} className="text-green-600 mr-2" />
                  <span className="text-gray-600">{t('coursePages.arduino.about.price')}</span>
                </div>
              </div>
            </motion.div>
            ...
            {/* What You'll Learn */}
            <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 shadow-lg">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('coursePages.arduino.learn.title')}</h2>
              <ul className="space-y-3">
                {t('coursePages.arduino.learn.features').map((feature, index) => (
          ...
          >
            {/* Schedule */}
            <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 shadow-lg">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('coursePages.arduino.program.title')}</h2>
              <div className="space-y-4">
                {t('coursePages.arduino.program.weeks').map((item, index) => (
            ...
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl p-8 text-white text-center">
              <h3 className="text-2xl font-bold mb-4">{t('coursePages.arduino.cta.title')}</h3>
              <p className="mb-6 opacity-90">
                {t('coursePages.arduino.cta.subtitle')}
              </p>
              <a
              ...
              >
                {t('coursePages.arduino.cta.button')}
              </a>
            </motion.div>
          </motion.div>
        </div>
