      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">{t('coursePages.it.title')}</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {t('coursePages.it.subtitle')}
            </p>
            <div className="mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 shadow-lg">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('coursePages.it.about.title')}</h2>
              <p className="text-gray-600 leading-relaxed mb-6">
                {t('coursePages.it.about.description')}
              </p>
              
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center">
                  <Clock size={20} className="text-primary-600 mr-2" />
                  <span className="text-gray-600">{t('coursePages.it.about.duration')}</span>
                </div>
                <div className="flex items-center">
                  <Users size={20} className="text-primary-600 mr-2" />
                  <span className="text-gray-600">{t('coursePages.it.about.groupSize')}</span>
                </div>
                <div className="flex items-center">
                  <Target size={20} className="text-primary-600 mr-2" />
                  <span className="text-gray-600">{t('coursePages.it.about.age')}</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle size={20} className="text-green-600 mr-2" />
                  <span className="text-gray-600">{t('coursePages.it.about.price')}</span>
                </div>
              </div>
            </motion.div>
            ...
            {/* What You'll Learn */}
            <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 shadow-lg">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('coursePages.it.learn.title')}</h2>
              <ul className="space-y-3">
                {t('coursePages.it.learn.features').map((feature, index) => (
          ...
          >
            {/* Course Program */}
            <motion.div variants={itemVariants} className="bg-white rounded-2xl p-8 shadow-lg">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('coursePages.it.program.title')}</h2>
              <div className="space-y-4">
                {t('coursePages.it.program.weeks').map((item, index) => (
            ...
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl p-8 text-white text-center">
              <h3 className="text-2xl font-bold mb-4">{t('coursePages.it.cta.title')}</h3>
              <p className="mb-6 opacity-90">
                {t('coursePages.it.cta.subtitle')}
              </p>
              <a
